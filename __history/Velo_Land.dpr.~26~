...
uses
  ...
  Tests in 'Tests.pas' {Test},
  Game in 'Game.pas' {PicturesGame},
  AboutProgram in 'AboutProgram.pas' {AProgramm};
...
begin
  ...
  Application.CreateForm(TPicturesGame, PicturesGame);
  Application.CreateForm(TAProgramm, AProgramm);
  LoadScreen.Hide;
  LoadScreen.Free;
  Application.Run;
end.
