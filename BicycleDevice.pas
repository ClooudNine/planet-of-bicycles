unit BicycleDevice; // модуль раздела "Устройство велосипеда"
...
procedure TDevice.FormActivate(Sender: TObject); //открытие HTML-страницы с разделом "Устройство велосипеда"
begin
...
procedure TDevice.PageBeforeScriptExecute(ASender: TObject;
  const pDispWindow: IDispatch); // закртие формы
begin
Device.Close;
end;
