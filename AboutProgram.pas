unit AboutProgram; // модуль окна "О программе"
...
procedure TAProgramm.FormCreate(Sender: TObject); // загрузка информации "О программе"
begin
...
Version.Caption := 'Версия: Планета велосипедов 1.0';
Developer.Font.Name := 'Minecraft Rus Regular';
Developer.Font.Size := 14;
Developer.Caption := 'Разработчик: Сырель Владислав, учащийся УО ГГПК группы ПЗТ-34';
end;
